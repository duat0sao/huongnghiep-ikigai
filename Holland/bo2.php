...
<form method="post" action="xuly2.php">
    ...
    <!-- câu 2 bộ 1-->
    <div>
        <h4>Tôi có khả năng phân tích vấn đề</h4>
        <div>
    ...
    <!-- câu 3 bộ 1-->
    <div>
        <h4>Tôi biết suy nghĩ một cách mạch lạc, chặt chẽ</h4>
        <div>
    ...
    <!-- câu 4 bộ 1-->
    <div>
        <h4>Tôi thích thực hiện các thí nghiệm hay nghiên cứu</h4>
        <div>
    ...
    <!-- câu 5 bộ 1-->
    <div>
        <h4>Tôi có khả năng tổng hợp, khái quát, suy đoán những vấn đề</h4>
        <div>
    ...
    <!-- câu 6 bộ 1-->
    <div>
        <h4>Tôi thích những hoạt động điều tra, phân loại, kiểm tra, đánh giá</h4>
        <div>
    ...
    <!-- câu 7 bộ 1-->
    <div>
        <h4>Tôi tự tổ chức công việc mình phái làm</h4>
        <div>
    ...
    <!-- câu 8 bộ 1-->
    <div>
        <h4>Tôi thích suy nghĩ về những vấn đề phức tạp, làm những công việc phức tạp</h4>
        <div>
    ...
    <!-- câu 9 bộ 1-->
    <div>
        <h4>Tôi có khả năng giải quyết các vấn đề</h4>
        <div>
