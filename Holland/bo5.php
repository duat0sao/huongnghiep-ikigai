...
<form method="post" action="xuly5.php?kq1=<?php echo $ketqua1; ?>&kq2=<?php echo $ketqua2;?>&kq3=<?php echo $ketqua3;?>&kq4=<?php echo  $ketqua4;?>">
    <!-- câu 1 bộ 1-->
    <div>
        <h4>Tôi là người có tính phiêu lưu, mạo hiểm</h4>
        <div>
    ...
    <!-- câu 4 bộ 1-->
    <div>
        <h4>Tôi có khả năng diễn đạt, tranh luận, và thuyết phục người khác</h4>
        <div>
    ...
    <!-- câu 5 bộ 1-->
    <div>
        <h4>Tôi thíc các việc quản lý, đánh giá</h4>
        <div>
    ...
    <!-- câu 6 bộ 1-->
    <div>
        <h4>Tôi thường đặt ra các mục tiêu, kế hoạch trong cuộc sống</h4>
        <div>
    ...
    <!-- câu 7 bộ 1-->
    <div>
        <h4>Tôi thích gây ảnh hưởng đến người khác</h4>
        <div>
    ...
    <!-- câu 8 bộ 1-->
    <div>
        <h4>Tôi là người thích cạnh tranh, và muốn mình giói hơn người khác</h4>
        <div>
    ...
    <!-- câu 9 bộ 1-->
    <div>
        <h4>Tôi muốn người khác phải kính trọng, nể phục tôi</h4>
        <div>
