...
<form method="post" action="xuly4.php?kq1=<?php echo $ketqua1; ?>&kq2=<?php echo $ketqua2;?>&kq3=<?php echo  $ketqua3;?>">
    <!-- câu 1 bộ 1-->
    <div>
        <h4>Tôi là người thân thiện, hay giúp đỡ người khác</h4>
        <div>
    ...
    <!-- câu 2 bộ 1-->
    <div>
        <h4>Tôi thích gặp gỡ, làm việc với con người</h4>
        <div>
    ...
    <!-- câu 3 bộ 1-->
    <div>
        <h4>Tôi là người lịch sự, tử tế</h4>
        <div>
    ...
    <!-- câu 4 bộ 1-->
    <div>
        <h4>Tôi thích khuyên bảo, huấn luyện hay giảng giải cho người khác</h4>
        <div>
    ...
    <!-- câu 5 bộ 1-->
    <div>
        <h4>Tôi là người biệt lắng nghe</h4>
        <div>
    ...
    <!-- câu 6 bộ 1-->
    <div>
        <h4>Tôi thích các hoạt động chăm sóc sức khỏe của bản thân và người khác</h4>
        <div>
    ...
    <!-- câu 7 bộ 1-->
    <div>
        <h4>Tôi thích các hoạt độngvì mục tiêu chung của công đồng, xã hội</h4>
        <div>
    ...
    <!-- câu 8 bộ 1-->
    <div>
        <h4>Tôi mong muốn mình có thể đóng góp để xã hội tốt đẹp hơn</h4>
        <div>
