...
<form method="post" action="xuly3.php?kq1=<?php echo $ketqua1;?>&kq2=<?php echo $ketqua2;?>">
    <!-- câu 1 bộ 1-->
    <div>
        <h4>Tôi là người dễ xúc động</h4>
        <div>
    ...
    <!-- câu 2 bộ 1-->
    <div>
        <h4>Tôi có óc tưởng tượng phong phú</h4>
        <div>
    ...
    <!-- câu 3 bộ 1-->
    <div>
        <h4>Tôi thích sự tự do, không theo những quy định , quy tắc</h4>
        <div>
    ...
    <!-- câu 4 bộ 1-->
    <div>
        <h4>Tôi có khả năng thuyết trình, diễn xuất</h4>
        <div>
    ...
    <!-- câu 5 bộ 1-->
    <div>
        <h4>Tôi có thể chụp hình hoặc vẽ tranh, trang trí, điêu khắc</h4>
        <div>
    ...
    <!-- câu 6 bộ 1-->
    <div>
        <h4>Tôi có năng khiếu âm nhạc</h4>
        <div>
    ...
    <!-- câu 7 bộ 1-->
    <div>
        <h4>Tôi có khả năng viết, trình bày những ý tưởng của mình</h4>
        <div>
    ...
    <!-- câu 8 bộ 1-->
    <div>
        <h4>Tôi thích làm những công việc mới, những công việc đòi hỏi sự sáng tạo</h4>
        <div>
    ...
    <!-- câu 9 bộ 1-->
    <div>
        <h4>Tôi thoải mái bộc lộ những ý thích</h4>
        <div>
