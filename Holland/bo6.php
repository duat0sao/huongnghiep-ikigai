...
<form method="post" action="xuly6.php?kq1=<?php echo $ketqua1; ?>&kq2=<?php echo $ketqua2;?>&kq3=<?php echo $ketqua3;?>&kq4=<?php echo  $ketqua4;?>&kq5=<?php echo $ketqua5;?>">
    <!-- câu 1 bộ 1-->
    <div>
        <h4>Tôi là người có đầu óc sắp xếp, tổ chức</h4>
        <div>
    ...
    <!-- câu 3 bộ 1-->
    <div>
        <h4>Tôi là người chu đáo, chính xác và đáng tin cậy</h4>
        <div>
    ...
    <!-- câu 4 bộ 1-->
    <div>
        <h4>Tôi thích công việc tính toán sổ sách, ghi chép số liệu</h4>
        <div>
    ...
    <!-- câu 5 bộ 1-->
    <div>
        <h4>Tôi thíc các công việc lưu trữ, phân loại, cập nhất thông tin</h4>
        <div>
    ...
    <!-- câu 6 bộ 1-->
    <div>
        <h4>Tôi thường đặt ra những mục tiêu, kế hoạch trong cuộc sống</h4>
        <div>
    ...
    <!-- câu 7 bộ 1-->
    <div>
        <h4>Tôi thích dự kiến các khoản thu chi</h4>
        <div>
    ...
    <!-- câu 8 bộ 1-->
    <div>
        <h4>Tôi thích lập thời khóa biểu, sắp xếp lịch làm việc</h4>
        <div>
    ...
    <!-- câu 9 bộ 1-->
    <div>
        <h4>Tôi thích làm việc với các con số, làm việc theo hướng dẫn, quy trình</h4>
        <div>
