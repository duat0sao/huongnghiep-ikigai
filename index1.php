      ...
      <nav class="navbar navbar-expand-sm header-top">
          ...
          <div class="narr">
              <ul class="nav justify-content-end">
                  <?php
                    $idkhach = $_GET['id'];
                    $sql1="select hovaten from khach where idkhach='$idkhach'";
                  ...
                  ?>
                          ...
                          <li class="users">
                              ...
                              <li class="nav-item dropdown">
                                  <a class="nav-link dropdown-toggle magana" data-toggle="dropdown" href="#"><?php echo $tenkhach;?></a>
                                  <div class="dropdown-menu">
                                      <a class="dropdown-item i" href="account.php">Account</a>
                                     
                                      <a class="dropdown-item i" href="homthu.php">Hòm thư</a>
                                  </div>
                              </li>
                          
                          <li class="nav-item">
                              <a class="nav-link active" href="loginandout/logout.php">Logout</a>
                          </li>
  ...
  <!-- ikigai -->
    <div class="page">
	    <div class="venn-wrapper">
		    <h1>IKIGAI</h1>
		    <div class="venn-1">
			    <p><a href="toithich/index.php?id=<?php echo $idkhach;?>"> Bạn<b> thích</b> cái gì?</a></p>
